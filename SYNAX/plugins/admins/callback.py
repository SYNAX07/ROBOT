...
from SYNAX import YouTube, app
from SYNAX.core.call import DAXX
from SYNAX.misc import SUDOERS, db
from SYNAX.utils.database import (
    get_active_chats,
    get_lang,
    get_upvote_count,
    is_active_chat,
...
from SYNAX.utils.database import get_assistant
from SYNAX.utils.decorators.language import languageCB
from SYNAX.utils.formatters import seconds_to_min
from SYNAX.utils.inline import close_markup, stream_markup, stream_markup_timer
from SYNAX.utils.stream.autoclear import auto_clean
from SYNAX.utils.thumbnails import get_thumb
from config import (
    BANNED_USERS,
    SOUNCLOUD_IMG_URL,
    STREAM_IMG_URL,
