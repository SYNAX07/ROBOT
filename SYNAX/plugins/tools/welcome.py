...
import asyncio
import time
from SYNAX.utils.database import add_served_chat
from pyrogram.types import Message, InlineKeyboardMarkup, InlineKeyboardButton
from SYNAX.utils.database import get_assistant
import asyncio
from SYNAX.misc import SUDOERS
from SYNAX.mongo.afkdb import PROCESS
from pyrogram import Client, filters
...
from SYNAX.utils.database import get_assistant, is_active_chat
...
def welcomepic(pic, user, chatname, id, uname, brightness_factor=1.3):
    background = Image.open("SYNAX/assets/wel2.png")
    pfp = Image.open(pic).convert("RGBA")
    pfp = circle(pfp, brightness_factor=brightness_factor) 
    pfp = pfp.resize((635, 635))
    draw = ImageDraw.Draw(background)
    font = ImageFont.truetype('SYNAX/assets/font.ttf', size=70)
    welcome_font = ImageFont.truetype('SYNAX/assets/font.ttf', size=61)
